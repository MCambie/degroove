		...
		return(
            <View style = {styles.container}>
                ...
                <View style = {styles.form}>
                    ...
                    <FormLabel style = {styles.inactiveLabel}>First Name</FormLabel>
                    <FormInput style = {styles.form}/>
                    {/* <FormValidationMessage style = {styles.form}>{'This field is required'}</FormValidationMessage> */}
                    ...
                    <FormInput onChangeText={(input)=>this.emailinputChange(input)}/>
                    {/* <FormValidationMessage>{'This field is required'}</FormValidationMessage> */}
